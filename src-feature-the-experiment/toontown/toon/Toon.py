...
class Toon(Avatar.Avatar, ToonHead):
    ...
    def resetHeight(self):
        if hasattr(self, 'style') and self.style:
            ...
            elif self.cheesyEffect == ToontownGlobals.CESmallToon or self.cheesyEffect == ToontownGlobals.CESmallWhite:
            ...
            elif self.cheesyEffect == ToontownGlobals.CETitanToon:
    ...
    def __doCheesyEffect(self, effect, lerpTime):
        ...
        elif effect == ToontownGlobals.CETitanToon:
            return self.__doToonScale(ToontownGlobals.TitanToonScale, lerpTime)
        ...
        elif effect == ToontownGlobals.CESmallWhite:
            return self.__doBigAndWhite(VBase4(1, 1, 1, 1), ToontownGlobals.SmallToonScale, lerpTime)
